...
namespace DCProgs {
  ...
  class MSWINDOBE ExactSurvivor {
    ...
    public:
      ...
      t_rimatrix af(t_real t) const;
      //! Probability of no open times detected between 0 and t.
      t_rimatrix fa(t_real t) const;

      //! Gets the value of tau;
      t_real get_tau() const { return tau_; }
  
      //! Returns recursion matrix for af
      t_rimatrix recursion_af(t_uint _i, t_uint _m, t_uint _l) const;
      //! Returns recursion matrix for af
      t_rimatrix recursion_fa(t_uint _i, t_uint _m, t_uint _l) const;
      //! Returns Di  matrix for af
      t_rimatrix D_af(t_uint _i) const;
      //! Returns Di matrix for af
      t_rimatrix D_fa(t_uint _i) const;
...
#     endif
  ...
  class MSWINDOBE ExactSurvivor::RecursionInterface {
    ...
    public:
      ...
      decltype(t_rimatrix::Zero(1,1)) zero() const { return t_rimatrix::Zero(nopen, nopen); };
