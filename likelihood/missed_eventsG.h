...
namespace DCProgs {
  ...
  class MSWINDOBE MissedEventsG : protected ExactSurvivor, protected ApproxSurvivor {
    ...
    public:
      ...
      t_rimatrix const & get_af_factor() const { return af_factor_; }
      //! \f$Q_{FA}e^{-Q_{AA}\tau} \f$
      t_rimatrix const & get_fa_factor() const { return fa_factor_; }
...
#     endif
      ...
      t_real tmax_;
      //! \f$Q_{AF}e^{-Q_{FF}\tau} \f$
      t_rimatrix af_factor_;
      //! \f$Q_{FA}e^{-Q_{AA}\tau} \f$
      t_rimatrix fa_factor_;
  };
